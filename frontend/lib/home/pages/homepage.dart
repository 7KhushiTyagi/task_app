...
import 'package:frontend/home/pages/add_new_page.dart';
import 'package:frontend/home/widgets/date_selector.dart';
import 'package:frontend/home/widgets/task_card.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    context.read<AddNewTaskCubit>().getAllTasks(
          token: authState.user.token,
        );
    Connectivity().onConnectivityChanged.listen((data) async {
      if (data.contains(ConnectivityResult.wifi)) {
        await context.read<AddNewTaskCubit>().syncTasks(authState.user.token);
      }
    });
  }
